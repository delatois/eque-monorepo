      ...
      >
        ...
        <div className="relative z-10 mx-auto w-full max-w-4xl px-6 py-24 text-center md:px-12">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <a
              href="#"
              className="bracket font-display inline-flex h-11 items-center border border-[#252F3C] px-6 text-sm font-medium tracking-[0.02em] text-[#1FFFC3] transition-colors duration-120 hover:border-[rgba(31,255,195,0.4)] hover:bg-[rgba(31,255,195,0.08)] active:bg-[rgba(31,255,195,0.16)]"
            >
              Read the docs
            </a>
          </div>
        ...
        {/* Bottom meta strip */}
        <div className="absolute inset-x-0 bottom-0 z-10 border-t border-[#1A222D]">
